...
What Harry \emph{needed} to know was{\ldots} some way out of what was going to
...
talk about \emph{anything,} that had to contradict one of his Rules{\ldots}
...
neutralise him, but first get the Stone and resurrect Hermione{\ldots}}

\emph{{\ldots}convince Professor Quirrell to STOP THIS{\ldots}}
...
"\parsel{Why do you assk?}" hissed the Defence Professor, with a lilt to the hiss
...
associated with it{\ldots} "\parsel{How many anchorss did you make?}"

"\parsel{Would not ordinarily ssay, but iss clear you have already guesssed.}"
The Defence Professor's smile widened. "\parsel{Ansswer iss that I do not know.
...
at the time, since I realized that the ring had magic of unknown nature{\ldots}
...
own thought processes{\ldots} and had emerged as the calm, clear-headed, and
...
Perenelle{\ldots}? Or unless, by answering so quickly, the Defence Professor
...
"But I had said that I was following Snape," the Defence Professor said. "Was
that not plausible?"
...
The Defence Professor spoke. "I should also like to volunteer that Snape was
...
something else that he was{\ldots} obliged, Harry supposed, to ask. The bad
...
So that had been David Monroe, and that had been Lord Voldemort{\ldots}
...
"I wondered that myself," the Defence Professor said finally, "when I heard
...
"I see{\ldots}" the Defence Professor said slowly. "I see. I should have taught
