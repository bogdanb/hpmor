...
---hissed, "\parsel{Hungry, boy? Eat your fill sswiftly, we sshall need both
sstrength and time.}"

Harry's eyes were a bit wide, but he hissed, "\parsel{I ate well at breakfasst,}"
...
"\parsel{Do not wissh to explain here. Prefer to be elssewhere firsst. Need to
leave unobsserved, without ssign we have ever departed room.}"

"\parsel{Sso no one can track uss,}" hissed Harry.

"\parsel{Yess. Do you trusst me that much, boy? Think before ansswer. I will have
...
Slowly, slowly, as Professor Quirrell had instructed, the pouch began to float
...
"But the Dementors are \emph{not} invincible," said Harry. He could have cast
