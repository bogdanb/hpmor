...
\emph{themselves.} But most children simply take for granted that a Hat is
talking to them and do not wonder about how the Hat \emph{itself} works, so
that the mirror is not \emph{self}-reflective. And in \emph{particular} they
...
Hogwarts haven't read \emph{Godel, Escher, Bach}. May I please consider you sworn to
secrecy? That is \emph{why} we are talking about this, instead of my just
Sorting you.}"
...
some way to make \emph{sure} that no future child ever does this by accident---}
...
vocabulary, but it was still imbued with only its own strange goals…like
negotiating with an alien or an Artificial Intelligence…
...
already. But in actuality there is a great deal we need to discuss…oh,
no. Please don't. For the love of Merlin, \emph{must} you pull this sort of
...
\emph{But that is \emph{equally} an empty threat. You cannot fulfil your own
...
\emph{know,} while speaking to you, a statistical summary of what I remember, a
weighted average; I \emph{cannot} reveal to you the inner secrets of any other
...
\emph{can} tell you that there is definitely nothing like a ghost---mind,
...
thought about it, even he had to admit that…
...
little extra thinking. You \emph{know} that.}"
...
Again it was a shock. \emph{But what would the Hufflepuffs find in \emph{me},
...
the good of all the students in all the Houses…but I think you could
...
them…some of them did not.}"

That stopped Harry. But not for long. \emph{And of those who did \emph{not}
...
them. I just know that your chances don't feel good. They feel \emph{very} not-good.}"
...
morning to Neville Longbottom, deep inside you \emph{knew} that was wrong but
you did it \emph{anyway} because it was \emph{fun} and you had a \emph{good
excuse} and you thought the Boy-Who-Lived could \emph{get away} with it---}"

\emph{That's unfair! Now you're just dragging up inner fears that \emph{aren't}
necessarily real! I \emph{worried} that I \emph{might} be thinking like that,
but in the end I decided it would probably \emph{work} to help Neville---}
...
couldn't stand \emph{not} to do it, never mind Neville's terror.}"
...
Light in the world? Why must \emph{you} be the one to try for greatness, when I
...
have been reacting \emph{only} to the part about the Dark Lord still being
alive. You have essentially no idea of what the prophecy says or even if there
\emph{is} one. You're just speculating, or to put it more exactly, \emph{wishing}
that you have some ready-made heroic role that is your personal
property.}"
...
\emph{Well…yeah, frankly. I don't usually come out and say it like
that, but yeah. No point in softening it, you can read my mind anyway.}

"\emph{To the extent you really believe that…you must equally believe
...
accomplish still greater evil…But I won't do that.}

"\emph{Already you insist on risking it! Why are you so driven? What is the
real reason you must not go to Hufflepuff and \emph{be happier} there? What is
your true fear?}"
...
corner of your mind you know just exactly \emph{what} you aren't
thinking---you \emph{know} that by far the simplest explanation for this
...
\emph{Yes. And even if going to Ravenclaw \emph{strengthens} the coldness, that
doesn't mean the coldness will \emph{win} in the end.}
...
place of your \emph{last} chance to turn back. If you refuse one chance will
you not refuse others? It may be that your fate is already sealed, even by
doing this one thing.}"

\emph{But that is not certain.}

"\emph{That \emph{you} do not \emph{know} it for a certainty may reflect only
\emph{your} own ignorance.}"
...
\emph{If that's how it seems to you, then why aren't you just \emph{putting} me
