...
…but just in case, it was probably best to get in a bit of stress relief
first.
...
the feeling he was looking at something exploitable…he just wished his
...
Now to make this as vague as possible…something that wouldn’t hurt much
even if it did get out…"What I said was true. I did discover one of
...
than one thing…the obvious \emph{next} thought is that it has something
...
that actually be true…? But Dumbledore hadn’t seemed to act like
it…
...
either. Didn’t \emph{seem} to be Dumbledore’s style…but…
...
\emph{Great.} "Um…never use a complicated way of dealing with an enemy
...
shortly. For now…" Professor Quirrell took several steps forward, still
...
Wednesday…No, we do \emph{not} have time to wait."
...
your actions…do any of you wish to show your dominance over the
...
you \emph{please}…\emph{stop} that?"
...
after all…\emph{why} was Professor Quirrell so suspicious of him?
...
his ill-fated stay at Hogwarts and…Professor McGonagall would be angry
about that, but…
