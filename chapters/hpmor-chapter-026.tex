...
(\emph{That didn’t used to happen in the ancestral environment,} Harry’s brain
complained, and disoriented him.)
...
"Or anywhere I can buy a copy of the \emph{Daily Prophet.} Put me there and
I’ll be happy."

Shortly after, Harry had been delivered into a bookstore, accompanied by
several quietly spoken, ambiguous threats. And the shopkeeper had received
\emph{less} ambiguous threats, judging by the way he had cringed, and how his
...
"Mr~Potter…" Professor Quirrell said slowly, "are you \emph{sure} of
that?"
...
"He didn’t have any choice," said Harry. "Not if he wanted to fulfil the
...
to explain how I managed to remember this item, and the label attached to it,
...
trouble of putting it \emph{back}. So which is it to be?"
...
from trade, only without the trade part. Plus, \emph{we} didn’t steal it and it
