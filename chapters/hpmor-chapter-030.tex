...
army. A \emph{small} patch. If you wanted your soldiers to wear, say, coloured
...
Hufflepuffs and one Ravenclaw besides himself…not that there was any
...
And definitely \emph{not} segregated by House…except that no Slytherins
...
that one…unless Harry or the Squad Suggester prefixed the order with
...
military efficiency…but he'd been given a golden opportunity to change
...
But just in case she \emph{didn't}…well, that was why the Chaos Legion
...
Potter in Defence class, that time when Professor Quirrell had taught Harry how
...
\latersection{(Extempore speech given by General Potter to the Chaos Legion,
...
Dragon Army has never lost a single battle. And Hermione Granger…has a
...
that some day, our children can enjoy the taste of chocolate again. Everything
...
if they don't answer the right way on our tests…they'll fail the class.
Isn't that worth dying for? No, don't answer that. Some things are better left
unknown. None of us knows why we're here. None of us knows why we're fighting. We
...
students in those other armies out there…they're just like us. They
...
say now, because I won't get a chance later, that it was an honour to be your
...
in Defence class. Neville had hoped that sparring would fix everything that was
...
Chaotics before being felled by massed ground fire.

Hermione wasn't among the fallen. Draco must have got her and that was
...
among the attackers, so Draco hadn't had a chance to taunt her or ask her
...
And not only that, the Dragons believed they'd \emph{got} him, since they'd
...
Harry realized that the battle wasn't over. Right…he hadn't been hit by
...
angle shouldn't have been right but it did…"
...
Because Draco had already had that lecture, and, Harry suspected, discounted
...
"You haven't won \emph{yet,} General Potter!" snarled Draco. "Maybe we'll run
...
pressure…but then the rocks might fall in afterward and hit Draco, and
...
…it wasn't like he'd been about to leave the Muggle world to start a new
