...
</div><div  class='storycontent nocopy' id='storycontent' ><p>Any sufficiently advanced J. K. Rowling is indistinguishable from magic.
\sbreak
...
Though now that Harry remembered it, you weren't supposed to Transfigure things that were to be burned, which meant that going back in time afterward and getting Fred or George to Transfigure some carefully measured amount of explosives might not actually have been such a good idea{\ldots}
