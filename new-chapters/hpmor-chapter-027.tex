...
Chapter 27: Empathy\\
</div><div  class='storycontent nocopy' id='storycontent' ><p>J. K. Rowling is 87% confident you will burst into flames.
...
{\ldots}but they must have looked elsewhere and found \emph{someone} to help them do \emph{something} illegal, or they wouldn't have agreed to be Obliviated afterward.
...
And so the race between telepathic offense and telepathic defense had been a decisive win for defense. Otherwise the entire magical world, maybe even the whole Earth, would have been a very different place{\ldots}
